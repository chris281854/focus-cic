...
const DayDiv = React.memo(
  ({
    ...
    const divClassnames = {
      base: "row-span-1 col-span-1 border p-1 font-bold overflow-hidden hover:bg-primary/50 dark:hover:bg-slate-800 h-full min-h-full",
      otherMonthDays: "opacity-50",
      today: "bg-secondary dark:bg-slate-500",
    }
